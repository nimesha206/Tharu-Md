...
SESSION_ID: process.env.SESSION_ID || "SEON-MD=ucFFECBS#M4zgbBziGxzrlukEel4PlKsYNtc3LCObbp_mUg1ADyk",  // ADD Your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "THARU 𝙼𝙳 v2",
...
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/3nugy4.jpeg", //do not change alive img url
ALIVE_MSG: process.env.ALIVE_MSG || "ʜɪ ᴀᴍ ᴀʟɪᴠᴇ ɴᴏᴡ ᴀᴍ THARU ᴍᴅ ᴛʜᴇ ʙᴇsᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ🚀", // change alive msg if you wish
};
