            ...
            if (_0x1e75d9 === "2.1") {
              ...
              if (_0x1e75d9 === "2.2") {
                await _0xaf8db8.sendMessage(_0x5eb615, {
                  ...
                  'mimetype': "audio/mpeg",
                  'fileName': "NIMA/TWDL.mp3",
                  'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ THARUᴍᴅ*"
                }, {
                  'quoted': _0x2405c0
                });
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "ᴍʀ NIMA | " + _0x1d0aed.title + '.mp4',
